...
const RepoDetailsCard = ({repoDetails} : any) => {
    ...
    const { name, visibility, html_url, created_at, default_branch, owner, language } : any = repoDetails;
    const createdAt = Date(created_at)?.split("G")[0];

    return <Card className="w-96 rounded shadow-2xl  flex-col items-center justify-center" placeholder={undefined}>
    <CardBody className="rounded flex flex-col gap-2 flex-wrap justify-center items-center"  placeholder={undefined}>
      ...
      <div className="flex flex-col gap-3 mt-2">
        ...
        <Typography className="font-medium" textGradient  placeholder={undefined}>
